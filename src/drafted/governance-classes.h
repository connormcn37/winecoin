 ...
 *
 *   // network
 *   CWineNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.wine.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CWineNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: WineNetwork
// //   -- signature requirements : Key1(User)
// class CWineNetworkVariable : public CGovernanceObject
// {
// private:
