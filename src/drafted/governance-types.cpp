...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "WineNetwork") type = WineNetwork;
    if(strType == "WineNetworkVariable") type = WineNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == WineNetwork) s = "WineNetwork";
    if(type == WineNetworkVariable) s = "WineNetworkVariable";
