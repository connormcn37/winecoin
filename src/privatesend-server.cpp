...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Wine related functionality
...
/*
    ...
    allow endless transaction that would bloat Wine and make it unusable. To
