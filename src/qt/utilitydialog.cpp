    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Wine Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Wine Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  wine-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Wine in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 WINE, 0.1 WINE, 1 WINE and 10 WINE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://winepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://winepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Wine Core is shutting down...") + "<br /><br />" +
