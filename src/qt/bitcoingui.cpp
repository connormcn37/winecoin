    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Wine Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Wine address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and wine: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Wine Core"), this);
    aboutAction->setStatusTip(tr("Show information about Wine Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Wine Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Wine addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Wine addresses"));
    ...
    openAction->setStatusTip(tr("Open a wine: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Wine Core help message to get a list with possible Wine Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Wine Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Wine network", "", count));
    } else {
...
{
    QString strTitle = tr("Wine Core"); // default title
