    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("WINE-light"), QVariant("light"));
    ui->theme->addItem(QString("WINE-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("WINE-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("WINE-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("WINE-traditional"), QVariant("trad"));
