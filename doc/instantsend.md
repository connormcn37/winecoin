...
This mechanism has been integrated into Bitcore-Node-Wine which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/winepay/insight-api-wine#web-socket-api](https://github.com/winepay/insight-api-wine#web-socket-api)
* API: [https://github.com/winepay/insight-api-wine#instantsend-transactions](https://github.com/winepay/insight-api-wine#instantsend-transactions)
...
By default, the Wine Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Wine Core daemon:
